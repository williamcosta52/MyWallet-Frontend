...
### This project simulates a digital wallet, where the user can make incoming and outgoing transactions.
...
```bash
 $ npm install
```
### Create a environment variable and connect to backend:

#### Example: REACT_API_URL: http://localhost:BACKEND_PORT
